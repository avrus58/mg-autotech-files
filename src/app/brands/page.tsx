...
export const metadata: Metadata = {
  ...
  openGraph: { title: `${title} | MG AutoTech`, description, url: absoluteUrl("/brands"), siteName, type: "website", images: [{ url: "/opengraph-image", width: 1200, height: 630, alt: title }] },
...
export default function BrandsPage() {
  const jsonLd = {
    ...
    "@graph": [
      organizationJsonLd(),
      websiteJsonLd("en"),
      { "@type": "CollectionPage", "@id": `${absoluteUrl("/brands")}#page`, name: title, description, url: absoluteUrl("/brands"), isPartOf: { "@id": `${absoluteUrl("/")}#website` } },
