        ...
        <div style="background:#08090b;color:#ffffff;padding:24px 26px;">
          <table role="presentation" width="100%" cellspacing="0" cellpadding="0"><tr>
            ...
            <td style="vertical-align:middle;text-align:right;">
              <span style="display:inline-block;border:1px solid #3f3f46;border-radius:999px;padding:7px 10px;font-size:10px;font-weight:800;letter-spacing:0.08em;text-transform:uppercase;color:#e4e4e7;">Customer Portal</span>
            </td>
          </tr></table>
        </div>
        <div style="padding:30px 26px 32px;">
          <div style="margin-bottom:11px;font-size:11px;font-weight:900;letter-spacing:0.14em;text-transform:uppercase;color:#c1121f;">MG AutoTech Update</div>
          ...
          ${input.content}
          ${cta}
          <div style="margin-top:25px;border-left:3px solid #d11221;background:#fafafa;padding:13px 15px;color:#52525b;font-size:12px;line-height:1.65;">Dateien und vertrauliche technische Daten sind aus Sicherheitsgründen ausschließlich im angemeldeten MG AutoTech Kundenportal verfügbar.</div>
        </div>
