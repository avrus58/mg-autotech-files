...
const closeLabels: Record<WidgetLanguage, string> = {
  de: "Schließen",
  en: "Close",
  tr: "Kapat",
  fr: "Fermer",
...
export function PublicVehicleSelector({
  ...
  if (unavailable) {
    return <div translate="no" data-no-translate dir={language === "ar" ? "rtl" : "ltr"} className="flex min-h-56 items-center justify-center rounded-xl border border-zinc-300 bg-white p-8 text-center font-semibold text-zinc-700">{widgetT(language, "unavailable")}</div>;
  }
