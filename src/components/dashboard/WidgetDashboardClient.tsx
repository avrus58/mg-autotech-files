...
export function WidgetDashboardClient() {
  ...
  return <main data-no-translate className="mg-compact-ui min-h-screen bg-[#15181e] text-white"><CustomerPortalPageHeader eyebrow="MG AutoTech SaaS" title={widgetT(dashboardLanguage, "vehicleLookupCodeGenerator")} icon={Braces} heading width="wide" />
