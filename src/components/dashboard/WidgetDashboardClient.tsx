...
import { ArrowLeft, Braces, Check, ChevronDown, CircleHelp, Code2, Globe2, KeyRound, Loader2, LockKeyhole, Mail, MessageCircle, RefreshCw, Save, Settings2 } from "lucide-react";
...
type Payload = { client: CustomerWidgetClient | null; publicKey?: string | null; settings: WidgetSettings; domainRequests?: Array<{ id: string; requested_domain: string; status: string; created_at: string }> };
