...
export function CustomerPortalPageHeader({
  ...
  const titleClassName = "truncate text-xl font-black text-white sm:text-2xl lg:text-xl";
  ...
  return (
    ...
    >
      <div
        className={`mx-auto flex min-h-[4.75rem] items-center justify-between gap-4 px-4 py-3 lg:min-h-16 lg:gap-3 lg:px-5 lg:py-2.5 ${widthClasses[width]}`}
      >
        ...
        {actions ? <div className="flex shrink-0 items-center gap-2 lg:gap-1.5">{actions}</div> : null}
      </div>
    </header>
  );
}
